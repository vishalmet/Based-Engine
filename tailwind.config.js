...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        gradient1: 'gradient1 5s ease-in-out infinite',
        gradient2: 'gradient2 5s ease-in-out infinite',
        gradient3: 'gradient3 5s ease-in-out infinite',
        gradient4: 'gradient4 5s ease-in-out infinite',
      },
      colors: {
